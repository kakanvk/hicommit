    ...
    return (
        <div className="Contest p-6 px-7">
            <div className="flex flex-col gap-10">
                <ShineBorder
                    className="relative p-0 flex w-full flex-col items-center justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl"
                    ...
                    <div className="flex flex-col gap-5">
                        {
                            data.map((item, index) => {
                                return (
                                    <BlurFade key={index} delay={0.15 * index} yOffset={6}>
