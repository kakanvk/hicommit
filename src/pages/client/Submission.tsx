...
import { CalendarDays, Clock, Code, CornerDownRight, RefreshCcw, TriangleAlert } from "lucide-react";
        ...
        <div className="Result p-6 px-8 pb-[90px] flex flex-col gap-8">
            <Breadcrumb>
                <BreadcrumbList>
                    ...
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link to={`/course/${submission_id}`}>Kỹ thuật lập trình</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
                        <BreadcrumbLink asChild>
                            <Link to={`/problem/${submission_id}`}>Bài tập 1</Link>
                        </BreadcrumbLink>
                    </BreadcrumbItem>
                    <BreadcrumbSeparator />
                    <BreadcrumbItem>
            ...
            <div className="flex gap-8 mt-2 items-start">
                    ...
                    <div className="flex justify-between gap-4">
                        <div className="flex-1 flex flex-col items-start gap-2 justify-start">
                            ...
                            <p className="font-medium text-base">
                                ...
                                My Commit afsjfhsd fjs fs dfh djhfsjdf
                                sjf sjdhfs dfj sdjf js sjd fjsd hf dsf
                            </p>
                        ...
                        <div className="flex justify-between items-center p-3.5 px-5 border-t-[1px]">
                            <div className="flex flex-col gap-1.5">
                                ...
                                <span className="font-semibold">Gặp vấn đề</span> */}
                                    {/* <Dialog>
                                    <DialogTrigger>
                                        <Badge variant="secondary" className="rounded px-1.5">Xem chi tiết</Badge>
                                    </DialogTrigger>
                                    <DialogContent>
                                        <DialogHeader>
                                            <DialogTitle>Kết quả đánh giá</DialogTitle>
                                        </DialogHeader>
                                        <DialogDescription className="mt-4 text-">
                                            <div className="w-full font-medium flex flex-col gap-4">
                                                <div className="flex gap-3 justify-start items-center">
                                                    <div className="flex items-center gap-2.5">
                                                        <i className="fa-solid fa-circle-check text-green-600"></i>
                                                        <span className="text-sm">Kết quả đúng:</span>
                                                    </div>
                                                    <Badge variant="secondary" className="rounded px-2">3/4</Badge>
                                                </div>
                                                <div className="flex gap-3 justify-start items-center">
                                                    <div className="flex items-center gap-2.5">
                                                        <i className="fa-solid fa-circle-xmark text-red-500"></i>
                                                        <span className="text-sm">Kết quả sai:</span>
                                                    </div>
                                                    <Badge variant="secondary" className="rounded px-2">1/4</Badge>
                                                </div>
                                            </div>
                                        </DialogDescription>
                                        <DialogFooter>
                ...
                <div className="sticky top-6 w-[270px] bg-zinc-100/80 dark:bg-zinc-900 border rounded-lg flex flex-col items-center p-5">
                    ...
                    <RingProgress radius={90} stroke={12} progress={75} label="" textSize={28} />
                        ...
                        <Accordion type="multiple" className="flex flex-col gap-1 mb-6">
                            <AccordionItem value="item-1" className="border-0">
                                <AccordionTrigger className="text-sm font-semibold border-b-[1px] border-zinc-600 pb-1 hover:no-underline">
                                    <span>Unit Test<i className="fa-solid fa-circle text-[5px] ml-2 text-red-600 dark:text-red-500 -translate-y-1"></i></span>
                                </AccordionTrigger>
                                <AccordionContent>
